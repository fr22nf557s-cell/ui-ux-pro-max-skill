...
cp index.html shop.html product.html order.html _site/
...
sed -i.bak -e "s#assets/css/norvex.css\"#assets/css/norvex.css?v=$rev\"#" -e "s#assets/js/catalog.js\"#assets/js/catalog.js?v=$rev\"#" -e "s#assets/js/norvex.js\"#assets/js/norvex.js?v=$rev\"#" _site/index.html _site/shop.html _site/product.html _site/order.html
rm -f _site/*.bak
